...
class Report(object):
    ...
    def plot_features(self, ntop=3, path='temp',
        ...
        if self._feature_selection:
            ...
            return self.plot_features_a(coefs=self.coefficients,
    ...
    def plot_features_a(self, coefs, coef_names=None,
        ...
        for key, val in fs.items():
            ...
            figure_path = os.path.join(
                self.pathname, file_name + '_' + '_'.join(key.split(' ')) + '_feature_ranking.png')
            ...
            results.append(figure_path)
        return results

    def plot_scores_a(self, scores, scoring='auc', file_name='temp.png', min_val=None):
        ...
        figure_path = os.path.join(self.pathname, file_name)
        nc = df.shape[0]
        ...
        plt.tight_layout()
        plt.savefig(figure_path, transparent=False)
        return figure_path
